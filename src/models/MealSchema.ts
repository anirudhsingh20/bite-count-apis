...
mealSchema.pre('save', async function (next) {
  try {
    ...
    if ((this as any).tags && Array.isArray((this as any).tags)) {
      (this as any).tags = (this as any).tags.filter((tag: any) =>
...
mealSchema.statics.searchByName = function (
  query: string,
  page: number = 1,
  limit: number = 10
) {
...
mealSchema.statics.findByCalorieRange = function (
  minCalories: number,
  maxCalories: number,
  page: number = 1,
  limit: number = 10
...
mealSchema.statics.findByProteinRange = function (
  minProtein: number,
  maxProtein: number,
  page: number = 1,
  limit: number = 10
...
mealSchema.statics.findByFatRange = function (
  minFat: number,
  maxFat: number,
  page: number = 1,
  limit: number = 10
...
mealSchema.statics.findByCarbsRange = function (
  minCarbs: number,
  maxCarbs: number,
  page: number = 1,
  limit: number = 10
...
mealSchema.statics.findByTags = function (
  tags: string[],
  page: number = 1,
  limit: number = 10
) {
